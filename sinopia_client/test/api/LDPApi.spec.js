  ...
  describe('LDPApi', function() {
    ...
    describe.skip('headBase', function() {
      it('should call headBase successfully', function(done) {
        //uncomment below and update the code to test headBase
        //instance.headBase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe.skip('headGroup', function() {
      it('should call headGroup successfully', function(done) {
        //uncomment below and update the code to test headGroup
        //instance.headGroup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe.skip('optionsBase', function() {
      it('should call optionsBase successfully', function(done) {
        //uncomment below and update the code to test optionsBase
        //instance.optionsBase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe.skip('optionsGroup', function() {
      it('should call optionsGroup successfully', function(done) {
        //uncomment below and update the code to test optionsGroup
        //instance.optionsGroup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
