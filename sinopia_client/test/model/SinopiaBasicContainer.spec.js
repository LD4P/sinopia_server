  ...
  describe('(package)', function() {
    describe('SinopiaBasicContainer', function() {
      ...
      it('should create an instance of SinopiaBasicContainer', function() {
        // TODO: update the code to test SinopiaBasicContainer
      ...
      it('should have the property rdfslabel (base name: "rdfs:label")', function() {
        // TODO: update the code to test the property rdfslabel
        expect(instance).to.have.property('rdfslabel');
        // expect(instance.rdfslabel).to.be(expectedValueLiteral);
      });
