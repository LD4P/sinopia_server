...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SinopiaServer.SinopiaResource();
  });
  ...
  describe.skip('SinopiaResource', function() {
    it('should create an instance of SinopiaResource', function() {
      // uncomment below and update the code to test SinopiaResource
      //var instance = new SinopiaServer.SinopiaResource();
      //expect(instance).to.be.a(SinopiaServer.SinopiaResource);
    });
