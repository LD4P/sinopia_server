...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/LDPContainer', 'model/Resource', 'model/SinopiaBasicContainer', 'model/SinopiaResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/LDPContainer'), require('../model/Resource'), require('../model/SinopiaBasicContainer'), require('../model/SinopiaResource'));
  } else {
    // Browser globals (root is window)
    if (!root.SinopiaServer) {
      root.SinopiaServer = {};
    }
    root.SinopiaServer.LDPApi = factory(root.SinopiaServer.ApiClient, root.SinopiaServer.ErrorResponse, root.SinopiaServer.LDPContainer, root.SinopiaServer.Resource, root.SinopiaServer.SinopiaBasicContainer, root.SinopiaServer.SinopiaResource);
  }
}(this, function(ApiClient, ErrorResponse, LDPContainer, Resource, SinopiaBasicContainer, SinopiaResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.link specifies container type.  Callers creating non-RDF should use &#39;&lt;http://www.w3.org/ns/ldp#NonRDFSource&gt;; rel&#x3D;\&quot;type\&quot;&#39;, those creating RDF should use &#39;&lt;http://www.w3.org/ns/ldp#RDFSource&gt;; rel&#x3D;\&quot;type\&quot;&#39;.
     ...
     * @param {String} opts.prefer Used to request certain behavior from Trellis, used to request provenance metadata for indexing.
     ...
     * @param {String} opts.accept The MIME type of the desired resource.  Callers wanting non-RDF should ask for application/json, those wanting RDF should ask for application/ld+json.
     * @param {String} opts.prefer Used to request certain behavior from Trellis, used to request provenance metadata for indexing.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/SinopiaResource}
     */
    this.getResource = function(groupID, resourceID, opts) {
      return this.getResourceWithHttpInfo(groupID, resourceID, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
