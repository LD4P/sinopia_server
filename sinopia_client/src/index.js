...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/ErrorResponse', 'model/ErrorSource', 'model/HealthCheckResponse', 'model/LDPContainer', 'model/Resource', 'model/ResourceContext', 'model/ResourceInfo', 'model/Variable', 'api/DefaultApi', 'api/LDPApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Error'), require('./model/ErrorResponse'), require('./model/ErrorSource'), require('./model/HealthCheckResponse'), require('./model/LDPContainer'), require('./model/Resource'), require('./model/ResourceContext'), require('./model/ResourceInfo'), require('./model/Variable'), require('./api/DefaultApi'), require('./api/LDPApi'));
  }
}(function(ApiClient, Error, ErrorResponse, ErrorSource, HealthCheckResponse, LDPContainer, Resource, ResourceContext, ResourceInfo, Variable, DefaultApi, LDPApi) {
  'use strict';
